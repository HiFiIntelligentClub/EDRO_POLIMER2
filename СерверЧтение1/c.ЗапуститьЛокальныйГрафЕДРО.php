...
function readAudioBuff()
	...
	while(true)
		...
		$мУрМакс	= мУрМаксимумНаШиринеСпектра($сАудио, $ч1СемпловНаПолосу);
...
function мУрМаксимумНаШиринеСпектра($сАудио, $ч1СемпловНаПолосу, $фАудиоДанные)
	{
	...
	$ч1УрМакс2	= 1;
	//$ч1Экр	= 1;
	for($ч0БайтШаг=0;$ч0БайтШаг<$ч1АудиоДлинна;$ч0БайтШаг++)
		{
		for($ч1Экр=1;$ч1Экр<=$ч1СемпловНаПолосу;$ч1Экр++)
			{
			$ч1Ур	= bin2hex($сАудио[$ч0БайтШаг]);
